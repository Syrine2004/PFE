...
public class RabbitMQConfig {
    ...
    public static final String QUEUE_CONCOURS_DELETED = "q.concours.deleted";
    ...
    public TopicExchange concoursExchange() {
        return new TopicExchange(EXCHANGE_CONCOURS);
    }

    @Bean
    public Binding concoursDeletedBinding(Queue concoursDeletedQueue, TopicExchange concoursExchange) {
