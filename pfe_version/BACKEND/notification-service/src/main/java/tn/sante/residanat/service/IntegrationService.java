...
public class IntegrationService {
     ...
     */
    public void sendN8nNotification(Long candidatId, String status, Long referenceId, String message) {
        try {
            ...
            payload.put("message", message); // <--- Added
            ...
            log.info("Successfully notified n8n for candidate {}", candidatId);
